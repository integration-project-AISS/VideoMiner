...
public class ChannelController {
    ...
    // PUT http://localhost:8080/api/channels/{id}
    ...
    public void update(
        ...
        Channel existingChannel = repository.findById(id)
                .orElseThrow(() ->
                        new ResponseStatusException(
                                HttpStatus.NOT_FOUND,
                                "Channel not found"
        ...
        repository.save(existingChannel);
    }

    // DELETE http://localhost:8080/api/channels/{id}
